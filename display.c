...
/*显示模式2*/
void SMG_DisplayModeTWO(int16_t ATT_MODE)
{ 
	if(ATT_MODE)
	{
		SMG_data_Decode_table[0][0]=data_SMG_seg_table[26];					//D5		H
	...
	{
		SMG_data_Decode_table[0][0]=data_SMG_seg_table[23];					//D5	L
		SMG_data_Decode_table[0][1]=data_SMG_seg_table[22];					//D6	none
		SMG_data_Decode_table[0][2]=data_SMG_seg_table[22];					//D7	none
		SMG_data_Decode_table[0][3]=data_SMG_seg_table[22];					//D8  none
	}
		...
		SMG_data_Decode_table[0][6]=data_SMG_seg_table[21];					//D3	T
		SMG_data_Decode_table[0][7]=data_SMG_seg_table[10];					//D4	A
}

/*显示模式3*/
void SMG_DisplayModeTHIRD(int16_t TOFF_MODE)
{ 
			if(TOFF_MODE)
			{
				SMG_data_Decode_table[0][0]=data_SMG_seg_table[18];					//D5		n
...
/*OUT1,OUT2状态显示*/
void SMG_DisplayOUT_STATUS(uint8_t ADCINCheck,uint8_t ThresholdCheck)
{ 
		//OUT1_STATUS = GPIO_ReadInputDataBit(OUT1_GPIO_Port,OUT1_Pin);
		if(ADCINCheck<=(ThresholdCheck-30))
		{
...
{
			/*测试码，BIT1到BIT8显示1到8的数字*/
		SMG_data_Decode_table[0][0]=data_SMG_seg_table[38];
		SMG_data_Decode_table[0][1]=data_SMG_seg_table[38];
		SMG_data_Decode_table[0][2]=data_SMG_seg_table[38];
		SMG_data_Decode_table[0][3]=data_SMG_seg_table[38];
		SMG_data_Decode_table[0][4]=data_SMG_seg_table[13];
		SMG_data_Decode_table[0][5]=data_SMG_seg_table[18];
		SMG_data_Decode_table[0][6]=data_SMG_seg_table[14];
		SMG_data_Decode_table[0][7]=data_SMG_seg_table[38];
}
