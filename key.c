...
void Button_Init(void)
{
	...
	SetButton.LongTime = 50000*timer_period;   
	...
	ModeButton.LongTime = 50000*timer_period;		
	...
	UpButton.ShortTime = 100*timer_period;
	UpButton.LongTime = 2000*timer_period;
	...
	DownButton.ShortTime = 100*timer_period;
	DownButton.LongTime = 2000*timer_period;
