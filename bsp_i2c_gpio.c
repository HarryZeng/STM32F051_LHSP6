...
#define GPIO_PORT_I2C_SCL	SCL_GPIO_Port			/* GPIO端口 */
#define GPIO_PORT_I2C_SDA	SDA_GPIO_Port			/* GPIO端口 */
#define RCC_I2C_SCL_PORT 	RCC_AHBPeriph_GPIOA		/* GPIO端口时钟 */
#define RCC_I2C_SDA_PORT 	RCC_AHBPeriph_GPIOA		/* GPIO端口时钟 */
...
void bsp_InitI2C(void)
{
	...
	RCC_AHBPeriphClockCmd(RCC_I2C_SCL_PORT, ENABLE);	/* 打开GPIO时钟 */
	RCC_AHBPeriphClockCmd(RCC_I2C_SDA_PORT, ENABLE);	/* 打开GPIO时钟 */
